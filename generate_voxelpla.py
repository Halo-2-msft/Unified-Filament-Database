...
_VX_PLA_PRINT  = "190–220°C"   # Bambu PLA Basic profile
_VX_PLA_BED    = "35–45°C"
_VX_PLA_DRY    = "55°C / 6h"

_VX_PETG_PRINT = "235–265°C"   # PETG HF preset + raise nozzle to 265°C per VoxelPLA
_VX_PETG_BED   = "65–75°C"
_VX_PETG_DRY   = "65°C / 6h"

_VX_PLA_R  = ("USA-made; 250-machine farm-tested; HS rated to 400mm/s; "
               "use Bambu PLA Basic profile — no changes needed")
    ...
    "material_guide": [
        {
            ...
            "drying":          "55°C / 6h",
            "notes": ("Use Bambu PLA Basic profile — no changes needed per VoxelPLA. "
                      "Rated 400mm/s. Verify spool condition on arrival."),
        },
        {
            "material":        "PETG+ HS",
            ...
            "notes": ("Bambu: use PETG HF preset + raise nozzle to 265°C per VoxelPLA. "
                      "Must dry before printing. Textured PEI recommended."),
        },
        {
